...
import by.bsuir.Khamutouski.system.ImageFileFilter;
 ...
 *
 * */
public class KinderCreatingForm extends JFrame {
    /**
     ...
     * */
    public KinderCreatingForm(final FormManager manager) {
    ...
    public Kinder createKinder() {
        Kinder person = new Kinder(name, surname, photo);
        return person;
    }
}
